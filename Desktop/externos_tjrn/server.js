...
const options = {
    pfx: fs.readFileSync("certificado-lanlink.pfx"),
    //pfx: fs.readFileSync("E:\\Externos TJRN\\certificado-lanlink.pfx"),
    passphrase: "L@nlink@2022-2023"
};
...
//  res.render('pages/viewcontact', { data: { login: 'EXT_123456789' }});
//})
...
app.post('/', [
	check('sobrenome', 'sobrenome é obrigatório').not().isEmpty(),
...
https.createServer(options, app).listen(8443, function () {
    console.log("Working on port 8443");
});
